        ...
        builder: (context, child) => Stack(
          children: <Widget>[
            ClipPath(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: Constants.colorNearlyDarkBlue.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      Constants.colorNearlyDarkBlue.withOpacity(0.2),
                      Constants.colorNearlyDarkBlue.withOpacity(0.5)
                    ],
            ...
            ClipPath(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: Constants.colorNearlyDarkBlue,
                  gradient: LinearGradient(
                    colors: [
                      Constants.colorNearlyDarkBlue.withOpacity(0.4),
                      Constants.colorNearlyDarkBlue
                    ],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
            ...
            Positioned(
              ...
              child: ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: Constants.colorWhite2.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: Constants.colorWhite2.withOpacity(
